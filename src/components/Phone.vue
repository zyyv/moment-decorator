    ...
    <div class="bg-white w-full aspect-[402/874] rd-12.5 relative of-hidden">
      ...
      <div class="w-full h-15.5" p="x4 y5.25" flex items-center justify-between absolute top-0 z-100>
        ...
        <div class="flex justify-center items-center w-27 gap-7px">
          ...
          <svg width="28" height="13" viewBox="0 0 28 13" fill-basecolor xmlns="http://www.w3.org/2000/svg">
            <rect opacity="0.35" x="1.00684" y="0.5" width="24" height="12" rx="3.8" stroke-basecolor />
            <path opacity="0.4" d="M26.5068 4.78113V8.8566C27.3116 8.51143 27.8349 7.70847 27.8349 6.81886C27.8349 5.92926 27.3116 5.1263 26.5068 4.78113" />
            <rect x="2.50684" y="2" width="21" height="9" rx="2.5" />
          </svg>
        </div>
      </div>
      <!-- Slot Content -->
      ...
      <div class="w-full h-6.8 flex justify-center items-end pb-2 flex-shrink-0 absolute bottom-0 z-100">
        <div class="w-36 h-1.25 bg-dark dark:bg-light rd-full" />
      </div>
    </div>
